...
model_weights = 'model_weights/Keras_0.3.0_weights.h5'

#chexnet weights ; https://drive.google.com/file/d/19BllaOvs2x5PLV_vlWMy4i8LapLb2j6b/view
def create_chexnet(model_weights = model_weights,input_size=(224,224)):
  """
  model_weights: weights value in .h5 format of chexnet
  creates a chexnet model with preloaded weights present in model_weights file
  """
  ...
  chexnet.load_weights(model_weights)
...
# image_folder1 = '/content/drive/MyDrive/Medical-Image-Captioning/test_images/1'
# image1=['test_images/1/CXR54_IM-2145-1001.png']
# image2=['test_images/1/CXR54_IM-2145-1002.png']
# image1=['test_images/5/chest_img.jpg']
# image2=['test_images/5/chest_img.jpg']
